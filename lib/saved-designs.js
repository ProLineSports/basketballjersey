...
export const ASSET_LIMIT_BYTES = Object.freeze({
  free: 10 * 1024 * 1024,
  paid_credits: 25 * 1024 * 1024,
  unlimited: 100 * 1024 * 1024,
  lifetime: 250 * 1024 * 1024,
});
...
export function getAssetLimitBytes(plan) {
  return ASSET_LIMIT_BYTES[plan] || ASSET_LIMIT_BYTES.free;
}
